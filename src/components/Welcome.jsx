...
const StyledWelcome = styled(BioContent)`
    ...
    @media only screen and (min-width: 577px) and (max-width: 768.99px) { margin-bottom: 2rem; }
...
const BiggerHeading = styled(SectionHeading)`
    font-size: 3rem;
    font-weight: 800;
    @media only screen and (min-width: 0px) and (max-width: 320.99px) { font-size: 2rem; }
    @media only screen and (min-width: 321px) and (max-width: 576.99px) { font-size: 3rem; }
    @media only screen and (min-width: 577px) and (max-width: 768.99px) { font-size: 3rem; }
    @media only screen and (min-width: 769px) and (max-width: 1024.99px) { font-size: 3rem; } 
    @media only screen and (min-width: 1025px) and (max-width: 1366.99px) { font-size: 3rem; }
`;
