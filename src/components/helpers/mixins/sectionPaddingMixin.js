...
const sectionPaddingMixin = css`
    ...
    @media only screen and (min-width: 769px) and (max-width: 1024.99px) { padding: 3rem 6rem; } 
    @media only screen and (min-width: 1025px) and (max-width: 1366.99px) { padding: 2rem 6rem; }
`;
